...
class DashboradLender extends StatefulWidget {
  const DashboradLender({super.key});

  @override
  State<DashboradLender> createState() => _DashboradLenderState();
}

class _DashboradLenderState extends State<DashboradLender> {
  @override
